...
#SBATCH --array=1-24
#SBATCH --output=/cauwerx/gwas/05_gwas/03_probe_selection/data/log/01_probe_selection_All-%A_%a.out
...
pheno_all=$(echo "/cauwerx/gwas/04_phenotypes/data/pheno_ICD10_All_plink_v1.9.txt")

# Samples: white-british individuals; Generated by "01_samples/sample_filtering.R"
samples_all=$(echo "/cauwerx/gwas/01_samples/data/samples_white_british_plink1.9_All.txt")
...
# Output
output_all=$(echo "/cauwerx/gwas/05_gwas/03_probe_selection/data/temp/All/probe_effect_Fisher_All_chr${chr}")
