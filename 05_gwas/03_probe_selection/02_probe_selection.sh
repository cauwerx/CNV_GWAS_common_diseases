...
#SBATCH --array=1-3
#SBATCH --output=/cauwerx/gwas/05_gwas/03_probe_selection/data/log/02_probe_selection-%A_%a.out
...
Rscript /cauwerx/gwas/05_gwas/03_probe_selection/02_probe_selection.R ${sex}
