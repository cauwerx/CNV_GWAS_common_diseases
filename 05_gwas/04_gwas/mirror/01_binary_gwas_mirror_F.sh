...
#SBATCH --job-name=gwas_M_F      	# Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-24 
#SBATCH --output=/cauwerx/gwas/05_gwas/04_gwas/mirror/data/log/01_gwas_mirror_F-%A_%a.out
...
# Output
output_F=$(echo "/cauwerx/gwas/05_gwas/04_gwas/mirror/data/temp/F/gwas_mirror_F_chr${chr}")
