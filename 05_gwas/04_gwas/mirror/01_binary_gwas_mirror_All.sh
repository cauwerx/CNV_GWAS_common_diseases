...
#SBATCH --job-name=gwas_M_All      	# Give your job a name to recognize it in queue overview
...
# Parallelize by chromosme
#SBATCH --array=1-24 
#SBATCH --output=/cauwerx/gwas/05_gwas/04_gwas/mirror/data/log/01_gwas_mirror_All-%A_%a.out
...
# Output
output_all=$(echo "/cauwerx/gwas/05_gwas/04_gwas/mirror/data/temp/All/gwas_mirror_All_chr${chr}")
