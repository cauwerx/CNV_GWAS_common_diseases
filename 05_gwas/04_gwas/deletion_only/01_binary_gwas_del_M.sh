...
#SBATCH --job-name=gwas_del_M      	# Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-24 
#SBATCH --output=/cauwerx/gwas/05_gwas/04_gwas/deletion_only/data/log/01_gwas_del_M-%A_%a.out
...
# Output
output_M=$(echo "/cauwerx/gwas/05_gwas/04_gwas/deletion_only/data/temp/M/gwas_del_M_chr${chr}")
...
for p in $pheno_list; do
	...
	selected_probes=$(echo "/cauwerx/gwas/05_gwas/03_probe_selection/data/M/deletion_only/probes_del_M_chr${chr}.${p}.txt")
