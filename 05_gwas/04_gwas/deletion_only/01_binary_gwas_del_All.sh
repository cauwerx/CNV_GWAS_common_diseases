...
#SBATCH --job-name=gwas_del_All     # Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-24 
#SBATCH --output=/cauwerx/gwas/05_gwas/04_gwas/deletion_only/data/log/01_gwas_del_All-%A_%a.out
...
# Output
output_all=$(echo "/cauwerx/gwas/05_gwas/04_gwas/deletion_only/data/temp/All/gwas_del_All_chr${chr}")
...
for p in $pheno_list; do
	...
	selected_probes=$(echo "/cauwerx/was/05_gwas/03_probe_selection/data/All/deletion_only/probes_del_All_chr${chr}.${p}.txt")
