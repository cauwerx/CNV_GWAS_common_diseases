...
#SBATCH --job-name=gwas_U_M      	# Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-24 
#SBATCH --output=/cauwerx/gwas/06_gwas/04_gwas/u_shape/data/log/01_gwas_U_M-%A_%a.out
...
# Output
output_M=$(echo "/cauwerx/gwas/05_gwas/04_gwas/u_shape/data/temp/M/gwas_U_M_chr${chr}")
