...
#SBATCH --job-name=pruning_mirror  	# Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-3
#SBATCH --output=/cauwerx/gwas/05_gwas/05_pruning/mirror/data/log/01_pruning_mirror-%A_%a.out
...
Rscript /cauwerx/gwas/05_gwas/05_pruning/mirror/01_pruning_mirror.R ${sex}
