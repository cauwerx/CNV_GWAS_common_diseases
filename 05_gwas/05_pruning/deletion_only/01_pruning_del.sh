...
#SBATCH --job-name=pruning_del  # Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-3
#SBATCH --output=/cauwerx/gwas/05_gwas/05_pruning/deletion_only/data/log/01_pruning_del-%A_%a.out
...
Rscript /cauwerx/gwas/05_gwas/05_pruning/deletion_only/01_pruning_del.R ${sex}
