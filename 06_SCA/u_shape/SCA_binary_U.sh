...
#SBATCH --job-name=SCA_U        # Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-3
#SBATCH --output=/cauwerx/gwas/06_SCA/u_shape/data/log/SCA_binary_U-%A_%a.out
...
Rscript /cauwerx/gwas/06_SCA/u_shape/SCA_binary_U.R ${sex}
