...
#SBATCH --array=1-3
#SBATCH --output=/cauwerx/gwas/09_burden_analysis/data/log/01_CNV_burden_binary-%A_%a.out
...
# Binary traits
Rscript /cauwerx/gwas/09_burden_analysis/01_CNV_burden_binary.R ${b}

# Disease burden (= continuous)
Rscript /cauwerx/gwas/09_burden_analysis/01_CNV_burden_DiseaseBurden.R ${b}
