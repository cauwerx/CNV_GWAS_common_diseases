...
#SBATCH --job-name=CNVR_del         # Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-3
#SBATCH --output=/cauwerx/gwas/07_CNVR/deletion_only/data/log/01_GWAS_CNVR_del-%A_%a.out
...
Rscript /cauwerx/gwas/07_CNVR/deletion_only/01_CNVR_del.R ${sex}
