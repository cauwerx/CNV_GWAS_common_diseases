...
#SBATCH --job-name=CNVR_dup         # Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-3
#SBATCH --output=/cauwerx/gwas/07_CNVR/duplication_only/data/log/01_GWAS_CNVR_dup-%A_%a.out
...
Rscript /cauwerx/gwas/07_CNVR/duplication_only/01_CNVR_dup.R ${sex}
