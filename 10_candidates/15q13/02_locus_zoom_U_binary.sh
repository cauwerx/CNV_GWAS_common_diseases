...
#SBATCH --output=/cauwerx/gwas/10_candidates/15q13/data/log/02_locus_zoom_U_binary-%j.out
...
pheno=$(echo stroke_hemorrhagic)  

##################
#    RUN JOB     #
##################

Rscript /cauwerx/gwas/10_candidates/15q13/02_locus_zoom_U_binary.R ${chr} ${start} ${end} ${pheno}
