...
#SBATCH --output=/cauwerx/gwas/10_candidates/15q13/data/log/02_locus_zoom_dup_binary-%j.out
...
pheno=$(echo AKI-anaemia)  

##################
#    RUN JOB     #
##################

Rscript /cauwerx/gwas/10_candidates/15q13/02_locus_zoom_dup_binary.R ${chr} ${start} ${end} ${pheno}
