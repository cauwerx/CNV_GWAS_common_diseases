...
#SBATCH --output=/cauwerx/gwas/10_candidates/15q13/data/log/01_locus_zoom_dup-%j.out
...
pheno=$(echo MCH-heart_rate) 

##################
#    RUN JOB     #
##################

Rscript /cauwerx/gwas/10_candidates/15q13/01_locus_zoom_dup.R ${chr} ${start} ${end} ${pheno}
