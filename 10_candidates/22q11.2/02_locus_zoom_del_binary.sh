...
#SBATCH --output=/cauwerx/gwas/10_candidates/22q11.2/data/log/02_locus_zoom_del_binary-%j.out
...
Rscript /cauwerx/gwas/10_candidates/22q11.2/02_locus_zoom_del_binary.R ${chr} ${start} ${end} ${pheno}
