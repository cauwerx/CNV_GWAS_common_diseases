# Locus zoom plot for the association between the 22q11 locus and headaches/mineral & bilirubin disorders according to a mirrror association model.
...
# Output file
output_file <- paste0("/cauwerx/gwas/10_candidates/22q11.2/data/temp/locus_zoom/mirror_All_chr", chr, ":", start, ":", end)
...
for(p in unlist(strsplit(pheno, " "))) {
	...
	# Run PLINK	
	system(paste("/cauwerx/plink2/plink2",
				 "--threads 20",
	 			 "--bfile", plink_file,
	...
	# Save
	fwrite(df, paste0("/cauwerx/gwas/10_candidates/22q11.2/data/locus_zoom/mirror_All_chr", chr, ":", start, ":", end, ".", p, ".glm.logistic.hybrid"), col.names = T, row.names = F, quote = F, sep = "\t", na = NA)
