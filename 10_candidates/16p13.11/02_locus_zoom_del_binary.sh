...
#SBATCH --output=/cauwerx/gwas/10_candidates/16p13.11/data/log/02_locus_zoom_del_binary-%j.out
...
pheno=$(echo KS-epilepsy)  

##################
#    RUN JOB     #
##################

Rscript /cauwerx/gwas/10_candidates/16p13.11/02_locus_zoom_del_binary.R ${chr} ${start} ${end} ${pheno}
