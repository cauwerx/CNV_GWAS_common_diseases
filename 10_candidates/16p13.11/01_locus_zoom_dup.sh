...
#SBATCH --output=/cauwerx/gwas/10_candidates/16p13.11/data/log/01_locus_zoom_dup-%j.out
...
Rscript /cauwerx/gwas/10_candidates/16p13.11/01_locus_zoom_dup.R ${chr} ${start} ${end} ${pheno}
