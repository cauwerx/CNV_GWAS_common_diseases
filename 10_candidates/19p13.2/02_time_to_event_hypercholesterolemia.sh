...
#SBATCH --array=1-2
#SBATCH --output=/cauwerx/gwas/10_candidates/19p13.2/data/log/02_time_to_event_hypercholesterolemia-%A_%a.out
...
Rscript /cauwerx/gwas/10_candidates/19p13.2/02_time_to_event_hypercholesterolemia.R ${pheno}
