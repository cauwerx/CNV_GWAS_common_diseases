# Extract phenotype information for hypercholesterolemia and generate a PLINK-compatible file
...
# Phenotype list; Contains the definition of inclusion and exclusion lists for hypercholesterolemia with and without exclusion of people with related conditions
pheno_list <- as.data.frame(fread("/data/phenotypes/ICD10_hypercholesterolemia.txt", header = T))
...
# All
fwrite(pheno_all, "/cauwerx/gwas/10_candidates/19p13.2/data/pheno/hypercholesterolemia_ICD10_All.txt", col.names = T, row.names = F, quote = F, sep = "\t", na = "NA")
